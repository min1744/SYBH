...
setChartAreaData(monthData2);

var monthData3 = [];
$(".monthData").each(function() {
	monthData3.push($(this).val());
});
setChartAreaData(monthData3);
...
//2
function setChartAreaData2(monthData2) {
...
//3
function setChartAreaData3(monthData3) {
