		...
		<div id="board_box">
			...
			<div id="boardList">
				...
				<div class="map_wrap">
					...
					<script type="text/javascript"
						src="//dapi.kakao.com/v2/maps/sdk.js?appkey=9963d068218228f27bdac8c9618c4a07"></script>
					<script>
				...
				<div id="location_info">
					<ul>
						<li class="before"><span class="span_1">주소</span><span
							class="span_2">서울특별시 마포구 월드컵북로 21 풍성빌딩 </span></li>
						<hr>
						<li class="before"><span class="span_1">대표전화</span><span
							class="span_2">02)346-8546~8</span></li>
						...
						<div class="tab_container">
							...
							<div id="tab1" class="tab_content">
								...
								<div class="trans_info">
									<h3>
										서서울농협홍대역점 하차<br>(14-181)
									</h3>

									<div class="trans_list">
										<ul>
											<li><span class="bus1"> 일반버스 </span> 7016, 7711, 7737</li>
										</ul>
									</div>
								</div>
								<hr>
								<div class="trans_info">
									<h3>
										신한은행서교동금융센터점 하차<br>(14-921)
									</h3>

									<div class="trans_list">
										<ul>
											<li><span class="bus2"> 마을버스 </span> 마포09</li>
										</ul>
									</div>
								</div>
								<hr>
								<div class="trans_info">
									<h3>
										서울도시가스마포사옥<br>(14-192)
									</h3>

									<div class="trans_list">
										<ul>
											<li><span class="bus1"> 일반버스 </span> 7016, 7711, 7737</li>
											<li><span class="bus2"> 마을버스 </span> 마포06</li>
										</ul>
									</div>
								</div>
								<hr>
								<div class="trans_info">
									...
									<div class="trans_list">
										<ul>
											<li><span class="bus1"> 일반버스 </span> 7016, 7711, 7737</li>
											<li><span class="bus2"> 마을버스 </span> 마포06, 마포09</li>
										</ul>
									</div>
								</div>
