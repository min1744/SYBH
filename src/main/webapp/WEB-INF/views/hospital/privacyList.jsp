...
<link href="../resources/css/privacyList.css" rel="stylesheet">
</head>
<body>
<!-- header 추가 -->
...
<div id="board">
	...
	<div id="board_box">
		...
		<div id="boardList">
			 ...
			 <h3>개인정보처리방침</h3>
	        	 <p>
	        	 쌍용백병원(이하 “병원”이라 함)은 개인정보보호법 제30조에 따라 정보주체의 개인정보를 보호하고<br>
	        	 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침을 수립·공개합니다.<br>
